...
**Public Base URL:**
👉 https://qr-attendance-system-professional.onrender.com

The following APIs are available through the deployed application:

| API Endpoint | Description |
|--------------|-------------|
| `/api/attendance.php` | Handles attendance-related operations, including the registration and management of employee attendance records. |
| `/api/companies.php` | Provides API operations related to companies registered in the attendance management system. |
| `/api/notificaciones.php` | Handles notification-related operations generated by the application. |
| `/api/metrics.php` | Exposes application and business metrics in a Prometheus-compatible format for monitoring and observability. |
...
```text
https://qr-attendance-system-professional.onrender.com/api/metrics.php
```

This endpoint exposes application metrics such as:
* `employees_total`
* `attendance_total`
* `late_arrivals_total`
* `companies_total`
...
These metrics can be collected by **Prometheus** and visualized through **Grafana**, allowing the deployed application to be monitored through its business and operational metrics.

### 🔗 API Base URL

All public API endpoints use the following base URL:
```text
https://qr-attendance-system-professional.onrender.com
```

**Examples:**
* https://qr-attendance-system-professional.onrender.com/api/attendance.php
* https://qr-attendance-system-professional.onrender.com/api/companies.php
* https://qr-attendance-system-professional.onrender.com/api/notificaciones.php
* https://qr-attendance-system-professional.onrender.com/api/metrics.php

> 💡 **Note:** The API endpoints documented above represent the application's public API layer. Internal configuration files, source-code components, repositories, services, models, and test files are not exposed as public API endpoints.
